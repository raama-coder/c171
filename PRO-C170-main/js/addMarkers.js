AFRAME.registerComponent("create-markers", {
  ...
  init: async function() {
    ...
    dishes.map(dish => {
      ...
      pricePlan.setAttribute("src", "https://upload.wikimedia.org/wikipedia/commons/a/a8/Ski_trail_rating_symbol_black_circle.png")
      pricePlan.setAttribute("width", 0.8)
      pricePlan.setAttribute("height", 0.8)
      pricePlan.setAttribute("position", {x:-1.3, y:0, z:0.3})
      pricePlan.setAttribute("position", {x:-90, y:0, z:0})

      var price= document.createElement("a-entity");
      price.setAttribute("id", `price-${dish.id}`)
      price.setAttribute("text", {font:"arial", color:"white",width:3, align:"center", value:`only\n$${dish.price}` })
      price.setAttribute("position", {x:0.03, y:0.05, z:0.1})
      price.setAttribute("position", {x:0, y:0, z:0})
